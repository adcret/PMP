...
for i in range(len(images)):
    ...
    ax[2].hist(blob_Doh[:, 2]*np.sqrt(2), bins=20, color='red', alpha=0.7)
    ax[2].set_title('Size Distribution for DOH')
    ...
    ax[2].imshow(image_smoothed, cmap=plt.cm.gray)
    ax[2].set_title('difference of hessian')
    ...
    # Plot histogram of sizes for the current image
    plt.figure()
